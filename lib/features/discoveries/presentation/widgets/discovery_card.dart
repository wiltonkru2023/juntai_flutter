...
class DiscoveryCard extends StatelessWidget {
  ...
  final VoidCallback onTap, onCreate;
  @override
          ...
          Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Row(children: [
                      Expanded(
                          child: Text(discovery.businessName.toUpperCase(),
                    ...
                    Text(discovery.businessCategory,
                        style: const TextStyle(
                    ...
                    if ((discovery.groupBenefit ?? '').isNotEmpty)
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            Expanded(
                                child: Text(discovery.groupBenefit!,
                                    style: const TextStyle(
                    ...
                    if (discovery.activitiesCreated > 0)
                      Padding(
                          ...
                          child: Text(
                              '${discovery.activitiesCreated} encontros já foram criados aqui',
                              style: const TextStyle(
                                  fontSize: 12,
                                  color: AppColors.textSecondary))),
                  ])),
