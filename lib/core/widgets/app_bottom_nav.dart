...
class AppBottomNav extends StatelessWidget {
  ...
  void go(BuildContext c, int i) {
    const paths = ['/home', '/map', '/activity/create', '/chats', '/profile'];
    c.go(paths[i]);
  }
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text(label,
                        style: TextStyle(
                            ...
                            color:
                                active ? AppColors.primary : Colors.blueGrey)),
                    if (active && i != 2)
                      Container(
    ...
    return Material(
        ...
        child: SafeArea(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              ...
              item(1, Icons.location_on_outlined, 'Mapa'),
              Expanded(
                  child: InkWell(
                      onTap: () => go(context, 2),
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              item(3, Icons.chat_bubble_outline_rounded, 'Chat'),
